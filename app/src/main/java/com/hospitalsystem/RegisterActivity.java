...
import com.hospitalsystem.dto.UserDto;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText edFirstName, edLastName, edEmail, edPassword, edPassword2;
                ...
                mAuth.createUserWithEmailAndPassword(edEmail.getText().toString(), edPassword.getText().toString())
                        .addOnCompleteListener(this, task -> {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                DatabaseReference usersRef = ref.child("users").child(String.valueOf(edEmail.getText().toString().hashCode()));
